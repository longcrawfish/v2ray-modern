...
resolve_ws_tls_vars() {
  set_default_if_empty "PORT" "${CADDY_HTTPS_PORT}"
...
render_export_files() {
  ...
  render_dollar_template_file "${link_template}" "${EXPORT_DIR}/vless.txt" ${template_vars}
